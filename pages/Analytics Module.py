...
st.set_page_config(page_title="Real Estate App-Analytics Module")
st.title("Analytics")
...
# st.header('Most Features Wordcloud')

# font_path = 'C:\Windows\Fonts\Arial.ttf'  # Replace with your actual font path
...
st.header('Sector-wise BHK Pie Chart')
